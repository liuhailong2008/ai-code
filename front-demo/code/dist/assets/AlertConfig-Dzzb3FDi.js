import{b as l,c as i,d as t,F as b,r as v,t as a,h as g,n as f,f as h,e as x,g as _,i as o}from"./index-BAiDb5VL.js";import{_ as k}from"./_plugin-vue_export-helper-DlAUqK2U.js";const C={class:"page-header animate-in"},w={class:"page-actions"},L={class:"card animate-in delay-1"},P={class:"card-body",style:{padding:"0"}},z={class:"data-table"},H={class:"node-name"},S=["onClick"],$={class:"card animate-in delay-2",style:{"margin-top":"20px"}},A={class:"card-body"},B={__name:"AlertConfig",setup(D){const r=o(!1),c=o([{id:1,name:"链路延迟告警",type:"latency",condition:"> 250ms",duration:"5分钟",severity:"critical",enabled:!0},{id:2,name:"链路抖动告警",type:"jitter",condition:"> 50ms",duration:"10分钟",severity:"warning",enabled:!0},{id:3,name:"丢包率告警",type:"loss",condition:"> 1%",duration:"5分钟",severity:"critical",enabled:!0},{id:4,name:"节点离线告警",type:"offline",condition:"心跳超时",duration:"3分钟",severity:"critical",enabled:!0},{id:5,name:"P99延迟告警",type:"p99",condition:"> 200ms",duration:"15分钟",severity:"warning",enabled:!1}]),d=o(`groups:
